...
class Quiz3Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton = view.findViewById<Button>(R.id.next_button3)
        previousButton = view.findViewById<Button>(R.id.previous_button3)
        toolBar = view.findViewById<Toolbar>(R.id.toolbar3)
    ...
    companion object {
         ...
         * @return A new instance of fragment Quiz3_Fragment.
         */
