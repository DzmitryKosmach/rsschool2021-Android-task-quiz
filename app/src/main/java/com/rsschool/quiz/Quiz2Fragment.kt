...
class Quiz2Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton = view.findViewById<Button>(R.id.next_button2)
        previousButton = view.findViewById<Button>(R.id.previous_button2)
        toolBar = view.findViewById<Toolbar>(R.id.toolbar2)
    ...
    companion object {
         ...
         * @return A new instance of fragment Quiz2_Fragment.
         */
