...
class Quiz4Fragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        nextButton = view.findViewById<Button>(R.id.next_button4)
        previousButton = view.findViewById<Button>(R.id.previous_button4)
        toolBar = view.findViewById<Toolbar>(R.id.toolbar4)
    ...
    companion object {
         ...
         * @return A new instance of fragment Quiz4_Fragment.
         */
